/*
  ...
  - You are about to drop the column `authorId` on the `Option` table. All the data in the column will be lost.
...
CREATE TABLE "new_Option" (
    ...
    "deletedAt" DATETIME,
    CONSTRAINT "Option_productId_fkey" FOREIGN KEY ("productId") REFERENCES "Product" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
